 ...
 *   <li>{@link data.EntityReference#isToMany <em>To Many</em>}</li>
 *   <li>{@link data.EntityReference#getTarget <em>Target</em>}</li>
 * </ul>
 *
...
public interface EntityReference extends EObject {
	 ...
	 * @see data.DataPackage#getEntityReference_ToMany()
	 * @model
	 * @generated
	 */
	boolean isToMany();
	...
	/**
	 * Sets the value of the '{@link data.EntityReference#isToMany <em>To Many</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see data.DataPackage#getEntityReference_Target()
	 * @model required="true"
	 * @generated
	 */
	Entity getTarget();
	...
	/**
	 * Sets the value of the '{@link data.EntityReference#getTarget <em>Target</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
