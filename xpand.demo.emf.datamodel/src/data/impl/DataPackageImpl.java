...
public class DataPackageImpl extends EPackageImpl implements DataPackage {
	 ...
	 * @generated
	 */
	public EReference getDataModel_Entity() {
	 ...
	 * @generated
	 */
	public EAttribute getEntityReference_ToMany() {
	...
	public EReference getEntityReference_Target() {
		return (EReference)entityReferenceEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(dataModelEClass, DATA_MODEL__ENTITY);
		...
		createEAttribute(entityReferenceEClass, ENTITY_REFERENCE__TO_MANY);
	...
	public void initializePackageContents() {
		...
		initEReference(getDataModel_Entity(), this.getEntity(), null, "entity", null, 0, -1, DataModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEntity_Reference(), this.getEntityReference(), null, "reference", null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEntityReference_ToMany(), ecorePackage.getEBoolean(), "toMany", null, 0, 1, EntityReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
