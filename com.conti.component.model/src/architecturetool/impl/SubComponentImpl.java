 ...
 * </p>
 * <ul>
 *   <li>{@link architecturetool.impl.SubComponentImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubComponentImpl extends MinimalEObjectImpl.Container implements SubComponent {
	...
	protected EClass eStaticClass() {
		return ArchitecturetoolPackage.Literals.SUB_COMPONENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturetoolPackage.SUB_COMPONENT__NAME, oldName, name));
	}
