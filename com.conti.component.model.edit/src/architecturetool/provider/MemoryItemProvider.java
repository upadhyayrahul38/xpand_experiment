...
/**
 * This is the item provider adapter for a {@link architecturetool.Memory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturetoolPackage.Literals.MEMORY__MEMORYPARTITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Memory.class)) {
			case ArchitecturetoolPackage.MEMORY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ArchitecturetoolPackage.MEMORY__MEMORYPARTITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturetoolPackage.Literals.MEMORY__MEMORYPARTITION,
				 ArchitecturetoolFactory.eINSTANCE.createMemoryPartition()));
	}
