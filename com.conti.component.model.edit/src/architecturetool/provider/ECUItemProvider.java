...
/**
 * This is the item provider adapter for a {@link architecturetool.ECU} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ECUItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturetoolPackage.Literals.ECU__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturetoolPackage.Literals.ECU__CPUS);
			childrenFeatures.add(ArchitecturetoolPackage.Literals.ECU__FUNCTIONALREQUIREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturetoolPackage.Literals.ECU__CPUS,
				 ArchitecturetoolFactory.eINSTANCE.createCPU()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturetoolPackage.Literals.ECU__FUNCTIONALREQUIREMENTS,
				 ArchitecturetoolFactory.eINSTANCE.createFunctionalRequirement()));
	}
