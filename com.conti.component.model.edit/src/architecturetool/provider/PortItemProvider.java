...
/**
 * This is the item provider adapter for a {@link architecturetool.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturetoolPackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturetoolPackage.Literals.PORT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_ref_feature", "_UI_Port_type"),
				 ArchitecturetoolPackage.Literals.PORT__REF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParameterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_parameter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_parameter_feature", "_UI_Port_type"),
				 ArchitecturetoolPackage.Literals.PORT__PARAMETER,
				 true,
				 false,
				 true,
				 null,
