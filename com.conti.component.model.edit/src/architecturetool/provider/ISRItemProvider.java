...
/**
 * This is the item provider adapter for a {@link architecturetool.ISR} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ISRItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ISR_runnables_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ISR_runnables_feature", "_UI_ISR_type"),
				 ArchitecturetoolPackage.Literals.ISR__RUNNABLES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ISR_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ISR_name_feature", "_UI_ISR_type"),
				 ArchitecturetoolPackage.Literals.ISR__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ISR"));
	}
