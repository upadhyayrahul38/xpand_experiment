...
/**
 * This is the item provider adapter for a {@link architecturetool.OSApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OSApplicationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OSApplication_tasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OSApplication_tasks_feature", "_UI_OSApplication_type"),
				 ArchitecturetoolPackage.Literals.OS_APPLICATION__TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Isr feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsrPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OSApplication_isr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OSApplication_isr_feature", "_UI_OSApplication_type"),
				 ArchitecturetoolPackage.Literals.OS_APPLICATION__ISR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addMemorypartitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OSApplication_memorypartition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OSApplication_memorypartition_feature", "_UI_OSApplication_type"),
				 ArchitecturetoolPackage.Literals.OS_APPLICATION__MEMORYPARTITION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturetoolPackage.Literals.OS_APPLICATION__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((OSApplication)object).getName();
