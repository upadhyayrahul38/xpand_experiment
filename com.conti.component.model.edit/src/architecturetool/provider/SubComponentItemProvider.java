...
/**
 * This is the item provider adapter for a {@link architecturetool.SubComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubComponentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubComponent_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubComponent_name_feature", "_UI_SubComponent_type"),
				 ArchitecturetoolPackage.Literals.SUB_COMPONENT__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubComponent.class)) {
			case ArchitecturetoolPackage.SUB_COMPONENT__NAME:
