...
/**
 * This is the item provider adapter for a {@link architecturetool.CPU} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CPUItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ArchitecturetoolPackage.Literals.CPU__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchitecturetoolPackage.Literals.CPU__NODES);
			childrenFeatures.add(ArchitecturetoolPackage.Literals.CPU__MEMORY);
		}
	...
	public String getText(Object object) {
		String label = ((CPU)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ArchitecturetoolPackage.Literals.CPU__NODES,
				 ArchitecturetoolFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(ArchitecturetoolPackage.Literals.CPU__MEMORY,
				 ArchitecturetoolFactory.eINSTANCE.createMemory()));
	}
